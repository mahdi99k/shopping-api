...
//--------------------------------------------------------------------------------------------------------------- index , delete gallery
     ...
     //-------------------- GalleryController
         ...
         //------------------ ResourceGallery  (link image)
         env ----->   IMAGE_UPLOADED_FOR_GALLERY = "http://127.0.0.1:8000/storage/images/galleries/"
